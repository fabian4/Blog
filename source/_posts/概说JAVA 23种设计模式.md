---
title: 概说JAVA 23种设计模式
date: 2021/1/22
description: 概说JAVA 23种设计模式
top_img: 'https://fabian.oss-cn-hangzhou.aliyuncs.com/img/hVFzSKEaqDHUlvp.jpg'
cover: 'https://fabian.oss-cn-hangzhou.aliyuncs.com/img/hVFzSKEaqDHUlvp.jpg'
categories:
  - 设计模式
tags:
  - 设计模式
...
![20210129131657.png](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/pS2sNtHGxhKLd1q.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/N4y5rpdHq8G9tKb.png)
...
所谓抽象工厂模式就是提供一个接口，用于创建相关或者依赖对象的家族，而不需要明确指定具体类。他允许客户端使用抽象的接口来创建一组相关的产品，而不需要关系实际产出的具体产品是什么。这样一来，客户就可以从具体的产品中被解耦。它的优点是隔离了具体类的生成，使得客户端不需要知道什么被创建了，而缺点就在于新增新的行为会比较麻烦，因为当添加一个新的产品对象时，需要更加需要更改接口及其下所有子类。其UML结构图如下：
 ...
 ![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/z9Uy1SIrZcE2kFp.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/KMjEemhxvs9T5zc.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/mxCHL9SRQauJz5w.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/tC5uhdRrWYgev4z.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/6fGrVPDn2gYEkyo.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/UxEJYKpOIbgwfqL.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/aqKR7yJEzUc13fF.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/DunpVC7FJxRf1K8.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/2RJkTZa7Verqxoi.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/qS1omCadpVLINAi.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/BSa5tzhjuUirb1T.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/PJ2Coy6TUR8EVvr.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/pITZOSbKXqcnLhJ.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/TmpnJvYt6bDq3gL.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/HanisYtFfIpv7EG.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/HEGpR5gIjQU6svb.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/LDZSOopyjJ1bVXm.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/rT8CVjcMHv4No5n.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/Omca1shN58iFtSX.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/EwTZCMiURVGYx23.png)
...
![img](https://fabian.oss-cn-hangzhou.aliyuncs.com/img/hKBcxlIoMF8gmGV.png)
