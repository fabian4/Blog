---
title: Spring 中的9种设计模式
date: 2021/3/10
description: Spring 中的9种设计模式
top_img: >-
  https://fabian.oss-cn-hangzhou.aliyuncs.com/img/img-c6d3a2d229d395e79da66a8feff97814.jpg
cover: >-
  https://fabian.oss-cn-hangzhou.aliyuncs.com/img/img-c6d3a2d229d395e79da66a8feff97814.jpg
categories:
  - Spring
...
BeanFactory。Spring中的BeanFactory就是简单工厂模式的体现，根据传入一个唯一的标识来获取Bean对象，但是否在传入参数后创建还是传入参数前创建这个要根据具体情况来定
...
<img src="https://fabian.oss-cn-hangzhou.aliyuncs.com/img/image-20210319082150862.png" alt="image-20210319082150862" style="zoom:50%;" />
...
<img src="https://fabian.oss-cn-hangzhou.aliyuncs.com/img/image-20210319082321016.png" alt="image-20210319082321016" style="zoom:67%;" />
